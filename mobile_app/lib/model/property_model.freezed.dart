...
abstract class $PropertiesCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String name, String description, double price, String location});
}
...
class _$_Properties implements _Properties {
  ...
  @override
  String toString() {
    return 'Properties(id: $id, name: $name, description: $description, price: $price, location: $location)';
  }
